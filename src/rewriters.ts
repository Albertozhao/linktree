...
class AvatarRewriter {
    element(element) {
        element.setAttribute("src", "https://raw.githubusercontent.com/Albertozhao/linktree/main/images/jae-phan-profile.jpg")
    }
}
...
class HeadRewriter {
    element(element) {
        element.append(
            ...
            '<link rel="icon" type="image/png" href="https://raw.githubusercontent.com/Albertozhao/linktree/main/images/jae-phan-profile.jpg">',
            {
                html: true,
            },
        )
